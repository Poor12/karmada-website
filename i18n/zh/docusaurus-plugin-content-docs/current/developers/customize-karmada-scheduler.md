...
你需要编辑调度器的main函数 [cmd/scheduler/main.go](https://github.com/karmada-io/karmada/blob/master/cmd/scheduler/main.go)，传入自定义的插件配置。
...
...
 spec:
      ...
      - command:
        ...
        - --v=4
        image: docker.io/karmada/karmada-scheduler:xxxxx
...
```
